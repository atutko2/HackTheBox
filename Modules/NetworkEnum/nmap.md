...
`nmap -Pn 10.129.212.41 -p80 --script vuln `

reveals the robots.txt file
...
```
udo nmap 10.129.2.0/24 -F -oN tnet.default 
...
`sudo nmap 10.129.231.144 -sS -sV -F -O --max-retries=0 -D RND:5`

http://10.129.88.50/status.php
...
`sudo nmap 10.129.119.228 -sS -sV -F -O --max-retries=0 -D RND:5`

That gets me a detected and banned.

I had to start the Parrot VM and run this:

`sudo nmap -sV -sU -F 10.129.199.232 -Pn --script=dns-nsid --packet-trace`

Running the same thing gives me HTB984NIFN97CBO which is close but wrong.
...
Running this gets the ports:
`sudo nmap -sS -sV 10.129.216.152 -Pn -n --disable-arp-ping --packet-trace --source-port 53`

Running this gets nothing but reveals some versions:
`sudo nmap -sS -sV -p 22,80,50000 10.129.216.152 -Pn -n --disable-arp-ping --packet-trace --source-port 53`

This gets the answer:
`ncat -nv --source-port 53 10.129.216.152 50000`
